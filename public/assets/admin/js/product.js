    ...
    $("#whole-section").append(''+
                            '<div class="feature-area">'+
                                '<span class="remove whole-remove"><i class="fas fa-times"></i></span>'+
                                    '<div  class="row">'+
                                        '<div class="col-lg-6">'+
                                            '<input type="text" name="whole_sell_qty[]" class="input-field" placeholder="1-100" required>'+
                                        '</div>'+
                                        '<div class="col-lg-6">'+
                                            '<input type="text" name="whole_sell_discount[]" class="input-field" placeholder="2.99" required>'+
                                        '</div>'+
                                    '</div>'+
                            '</div>'
                            +'');        
