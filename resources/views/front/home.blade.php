...
@section('content')
    ...
    @endif
    <div class="category_selection pt-5 mt-5">
        <div class="container">
            <h2 class="heading_cat">{{$langg->categoryselections}}</h2>
            <div class="row">
    ...
    <div class="product_fetured mt-5 pt-5">
        <div class="container">
    ...
    <div class="featured_brands mt-5 pt-5">
        <div class="container">
            <h3>{{$langg->featuredbrands}}</h3>
            <div class="featured_iner">
    ...
    <div class="blog_section mt-5 pt-5">
        <div class="container">
            ...
            <div class="row">
                <div class="col-lg-2 col-md-4 offset-lg-1">
                    <div class="footer_main">
                        <div class="row">
                            <div class="col-md-3"> <img src="{{url('/front-end/images/plane_icon.png')}}" alt=""> </div>
                ...
                <div class="col-lg-2  col-md-4">
                    <div class="footer_main">
                        <div class="row">
                            <div class="col-md-3"> <img src="{{url('/front-end/images/value_icon.png')}}" alt=""> </div>
                            <div class="col-md-9" style="padding-left: 0;">
                ...
                <div class="col-lg-2  col-md-4">
                    <div class="footer_main">
                        <div class="row">
                            <div class="col-md-3"> <img src="{{url('/front-end/images/payment_icon.png')}}" alt=""> </div>
                            <div class="col-md-9" style="padding-left: 0;">
                ...
                <div class="col-lg-2  col-md-4">
                    <div class="footer_store"> <a href="#"> <img src="{{url('/front-end/images/apple_icon.png')}}" style="width: 75%;margin-bottom: 6px;" alt=""> </a> <a href="#"> <img src="{{url('/front-end/images/play_icon.png')}}" style="width: 75%;" alt=""> </a> </div>
                </div>
            </div>
        </div>
    </div>
